...
bool VisCheck::IntersectBVH(const BVHNode* node, const Vector3& rayOrigin, const Vector3& rayDir, float maxDistance, float& hitDistance) const
{
...
bool VisCheck::IsPointVisible(const Vector3& point1, const Vector3& point2) const
{
...
bool VisCheck::RayIntersectsTriangle(const Vector3& rayOrigin, const Vector3& rayDir, const TriangleCombined& triangle, float& t) const
{
