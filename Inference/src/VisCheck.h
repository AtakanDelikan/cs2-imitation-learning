...
public:
    ...
    void ExportToSTL(const std::string& optimizedGeometryFile);
    bool IsPointVisible(const Vector3& point1, const Vector3& point2) const;
...
private:
    ...
    bool IntersectBVH(const BVHNode* node, const Vector3& rayOrigin, const Vector3& rayDir, float maxDistance, float& hitDistance) const;
};
